 ...
 * Declare programs 
 **/
extern TANKFILL RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.TANKFILLAUTO_CMD), BOOL_ENUM},
{&(RES0__INSTANCE0.TANKVALVEOPEN), BOOL_ENUM},
{&(RES0__INSTANCE0.ESTOP_CMD), BOOL_ENUM},
{&(RES0__INSTANCE0.TANKLEVELHI_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE0.TANKLEVELLO_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE0.TANKLEVEL_LIT), REAL_ENUM},
{&(RES0__INSTANCE0.TANKEMPTY_SP), REAL_ENUM},
{&(RES0__INSTANCE0.TANKFULL_SP), REAL_ENUM},
{&(RES0__INSTANCE0.TANKLOALARM_SP), REAL_ENUM},
{&(RES0__INSTANCE0.TANKHIALARM_SP), REAL_ENUM}
};
